...
//Create variable to take data from html//
//Untuk acces data//
...
btnCreate.addEventListener('click', function(){  //creating text file when user click CREATE button
  ...
  fs.writeFile(file, contents, function(err){ //param1: textfile yg kita nak write param2: apa yg kita nak write ke text file //fs is obj
    ...
    console.log("The file was created") //will be display to console
...
btnRead.addEventListener('click', function(){  //read contents of the created text file
  ...
  fs.readFile(file, function(err, data){ 
    ...
    console.log("The file was read!")//will be display to console
  })
...
btnUpdate.addEventListener('click', function(){  
  ...
  fs.writeFile(file, contents, function(err){ //param1: textfile yg kita nak write param2: apa yg kita nak write ke text file
    if(err) throw err;
    console.log("The file was updated!")//will be display to console

    fileName.value = ""
    fileContents.value = ""

    alert("Content in file has been updated")//Alert box will pop-up
  })
...
btnDelete.addEventListener('click', function(){  
  ...
  fs.unlink(file, function(err){ 
    ...
    fileName.value = ""
    fileContents.value = ""
    console.log("The file was deleted!")//will be display to console
    alert("The file was deleted!")//Alert box will pop-up
  })
